...
import static com.example.pinakaappdev.AverageQuestions.answers;
import static com.example.pinakaappdev.AverageQuestions.choices;
import static com.example.pinakaappdev.AverageQuestions.question;
...
public class average_gameplay extends AppCompatActivity{
	...
	protected void onCreate(
		...
		setContentView(R.layout.activity_average_gameplay);
		...
		timerCountDown = new CountDownTimer(10030, 1000) {
            @Override
