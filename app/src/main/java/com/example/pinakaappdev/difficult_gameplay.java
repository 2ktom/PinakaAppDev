...
import static com.example.pinakaappdev.DifficultQuestions.answers;
import static com.example.pinakaappdev.DifficultQuestions.choices;
import static com.example.pinakaappdev.DifficultQuestions.question;
...
public class difficult_gameplay extends AppCompatActivity{
	...
	protected void onCreate(
		...
		setContentView(R.layout.activity_difficult_gameplay);

		TextViewTimer = findViewById(R.id.TimeNumber);

        option1 = findViewById(R.id.FirstBtn);
        option2 = findViewById(R.id.SecondBtn);
        option3 = findViewById(R.id.ThirdBtn);
        option4 = findViewById(R.id.FourthBtn);

        timerCountDown = new CountDownTimer(5030, 1000) {
            @Override
